...
<body>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="col-md-12">
				<form method="get" action="/payment" class="form-group details_frm">
					<div class="row">
						<div class="">
							<div class="form-group">
								<label for="contain" style="font-size:50px;text-align:center;width:100%">No Details Found</label> 
									<input type="submit" value="Go To Home" class="btn btn-primary mb-2" />
							</div>
						</div>
					</div>
				</form>
				...
				<div class="row">
					<div class="col-md-12">
						<p>
							...
							liabilities by the company.By proceeding with Click to Pay, 
							Customer confirms to have read and understood, 
							and further agrees to all the Terms and Conditions/General Notice on Click to Pay."
